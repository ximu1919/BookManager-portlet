...
import com.huqiwen.demo.book.NoSuchBooksException;
import com.huqiwen.demo.book.model.Books;
import com.huqiwen.demo.book.model.impl.BooksImpl;
import com.huqiwen.demo.book.model.impl.BooksModelImpl;
...
public class BooksPersistenceImpl extends BasePersistenceImpl<Books>
	...
	@Override
	public Books updateImpl(com.huqiwen.demo.book.model.Books books)
		throws SystemException {
		books = toUnwrappedModel(books);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.huqiwen.demo.book.model.Books")));
