...
public class BooksWrapper implements Books, ModelWrapper<Books> {
	...
	*/
	...
	@Override
	public int compareTo(com.huqiwen.demo.book.model.Books books) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.huqiwen.demo.book.model.Books> toCacheModel() {
		return _books.toCacheModel();
	}

	@Override
	public com.huqiwen.demo.book.model.Books toEscapedModel() {
		return new BooksWrapper(_books.toEscapedModel());
	}

	@Override
	public com.huqiwen.demo.book.model.Books toUnescapedModel() {
